var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="'+baseUrl+'/css/theme-default.css"><img src="'+baseUrl+'/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="'+baseUrl+'/css/theme-brown.css"><img src="'+baseUrl+'/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="'+baseUrl+'/css/theme-blue.css"><img src="'+baseUrl+'/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="'+baseUrl+'/css/theme-white.css"><img src="'+baseUrl+'/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="'+baseUrl+'/css/theme-black.css"><img src="'+baseUrl+'/img/themes/black.jpg"/></a>'
        +'</div>'
